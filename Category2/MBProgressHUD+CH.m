 ...
 *  @param view 显示的视图
 */
+ (void)show:(NSString *)text icon:(NSString *)icon view:(UIView *)view time:(NSInteger)time
{
...
//    hud.bezelView.color = [UIColor colorWithHex:@"000000"];
    hud.bezelView.color = [UIColor colorWithHex:@"000000" alpha:0.7];
    [hud.bezelView setStyle001:10.0f withBorderColor:[UIColor colorWithHex:@"000000" alpha:0]];
...
{
    [self show:success icon:@"success.png" view:view time:2];
}
...
+ (void)showError:(NSString *)error toView:(UIView *)view{
    [self show:error icon:@"error.png" view:view time:2];
}
